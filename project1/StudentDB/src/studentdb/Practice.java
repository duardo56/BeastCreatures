...
public class Practice extends JPanel{
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createNativeQuery("SELECT * FROM tests_data WHERE course_id = 'cs4303';", studentdb.TestsData.class);
        list = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : org.jdesktop.observablecollections.ObservableCollections.observableList(query.getResultList());
        testsDataQuery = java.beans.Beans.isDesignTime() ? null : entityManager.createNativeQuery("SELECT * FROM tests_data WHERE course_id = 'cs4303';", studentdb.TestsData.class);
        testsDataList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : testsDataQuery.getResultList();
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, testsDataList, masterTable);
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                Practice.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                Practice.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                Practice.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                Practice.this.deleteButtonActionPerformed(evt);
            }
        }
    }// </editor-fold>                        
    ...
    private java.util.List<studentdb.TestsData> testsDataList;
    private javax.persistence.Query testsDataQuery;
