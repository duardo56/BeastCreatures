...
public class NewMasterDetailForm extends JPanel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM CoursesData c");
        ...
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${courseName}"));
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.courseName}"), courseNameField, org.jdesktop.beansbinding.BeanProperty.create("text"));
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<studentdb.CoursesData> toRemove = new ArrayList<studentdb.CoursesData>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            studentdb.CoursesData c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        studentdb.CoursesData c = new studentdb.CoursesData();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<studentdb.CoursesData> merged = new ArrayList<studentdb.CoursesData>(list.size());
            for (studentdb.CoursesData c : list) {
    ...
    private java.util.List<studentdb.CoursesData> list;
