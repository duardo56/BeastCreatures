...
public class Prof_classes extends JPanel {
    ...
    public List dbList(String username) {
    return entityManager.createQuery(
    "SELECT c FROM TeacherSchedule c WHERE c.Facutly_id LIKE :username")
    .setParameter("Facutly_id", username)
    .getResultList();
}
    //String queryString = "SELECT a FROM TeacherSchedule a WHERE a.Facutly_id = 'bowmanaa1'";
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT a FROM TeacherSchedule a WHERE Facutly_id = 'bowmanaa1'");
